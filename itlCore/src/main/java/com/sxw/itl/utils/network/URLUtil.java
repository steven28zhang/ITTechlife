...
public final class URLUtil {
    ...
    public static Proxy proxy = new Proxy(Type.HTTP, new InetSocketAddress(ITLConstants.proxyHost,
            ITLConstants.proxyPort));
     ...
     * @return
     */
    public static String surfing(final String url) {
        String result = "";

        try {
            URL url_ = new URL(url);
            url_.openConnection();
            result = ApacheIOUtils.convertInputStreamToString(url_.openConnection().getInputStream());
        } catch (java.net.ConnectException e) {
            e.printStackTrace();
            try {
                URL url_ = new URL(url);
                url_.openConnection(proxy);
                result = ApacheIOUtils.convertInputStreamToString(url_.openConnection(proxy).getInputStream());
     ...
     * @return
     */
    public static String baiduPlaceSearch(final String queryWords, final String region, final String outputType) {
        String result = "";
     ...
     * @return
     */
    public static String baiduPlaceSuggestionSearch(final String queryWords, final String region,
