...
public class TrackHttpRequest {
    ...
    public static void outputHttpRequest(final HttpServletRequest httpServletRequest) {
        String methodName = className + ":outputHttpRequest:";
        StringBuffer sb = new StringBuffer("");
        // remote
        sb.append("remote:").append(httpServletRequest.getRemoteAddr()).append(":")
                .append(httpServletRequest.getRemoteHost()).append(":").append(httpServletRequest.getRemotePort())
                .append(":").append(httpServletRequest.getRemoteUser());
        sb.append("\n");
        sb.append("Locale:").append(httpServletRequest.getLocale().toString()).append(":")
                .append(httpServletRequest.getLocalAddr());
        sb.append("\n");
        try {
            sb.append("body of the request:").append(httpServletRequest.getReader().toString()).append(":");
        } catch (IOException e) {
        } catch (Exception e) {
        }
        sb.append("\n");
        sb.append("server:").append(httpServletRequest.getScheme()).append(":")
                .append(httpServletRequest.getServerName()).append(":").append(httpServletRequest.getServletPath())
                .append(":").append(httpServletRequest.getServletContext()).append(":")
        ...
        while (atts.hasMoreElements()) {
            ...
            sb.append(attTmp).append(":").append(httpServletRequest.getAttribute(attTmp)).append(":");
        }
        ...
        if (headers != null) {
            ...
            while (headers.hasMoreElements()) {
                ...
                sb.append(attTmp).append(":").append(httpServletRequest.getHeader(attTmp)).append(":");
            }
        }

        sb.append("\n");
        sb.append(":OTHERS:").append(httpServletRequest.getAuthType()).append(":");
        sb.append("PathInfo:").append(httpServletRequest.getPathInfo()).append(":");
        sb.append("QueryString:").append(httpServletRequest.getQueryString()).append(":");
        sb.append("UserPrincipal:").append(httpServletRequest.getUserPrincipal()).append(":");
        ...
        if (session != null) {
            ...
            while (attsSession.hasMoreElements()) {
                ...
                sb.append(attTmp).append(":").append(session.getAttribute(attTmp)).append(":");
            }
        }
